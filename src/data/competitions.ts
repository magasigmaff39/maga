...
export const COMPETITIONS_DATABASE: Competition[] = [
  ...
  },
  {
    ...
    impact: 'Одна из самых престижных международных олимпиад в СНГ и Азии. Медаль IZhO гарантирует зачисление и стипендии в ведущие мировые университеты (KAIST, HKUST, NU, МФТИ).',
