...
[Контактный телефон / Email]`;
  ...
  const handleCopyTemplate = () => {
    navigator.clipboard.writeText(teacherEmailTemplate);
    ...
    <div className="space-y-8 py-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">
            Этап 07 • Первоочередной регламент
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
            Ключевая задача текущего периода
          </h2>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Фокусная контрольная точка, требующая выполнения на текущей рабочей неделе.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          >
            ...
            <span>Отправить план на Gmail (Google SMTP)</span>
          </button>
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <span className="px-3 py-1 rounded-md bg-slate-800 text-slate-200 text-xs font-semibold border border-slate-700">
              Приоритетная задача недели
            </span>

            <span className="text-xs text-slate-400 font-mono">
              Контрольный срок: {currentStepData.deadline}
            </span>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-800/80 border border-slate-700 space-y-1.5">
            <span className="text-xs font-semibold text-slate-300 uppercase tracking-wider block flex items-center gap-1.5">
              ...
              <span>Рекомендация по выполнению:</span>
            </span>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-normal">
              {currentStepData.guidanceTip}
            </p>
          </div>
                ...
                {activeRoadmapStep.subtasks.map((task) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] uppercase font-semibold text-slate-400 px-2 py-0.5 rounded bg-slate-900">
                      {task.isCompleted ? 'Выполнено' : 'Отметить'}
                    </span>
                  </div>
                ))}
              </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Деловой шаблон официального обращения к учителю или научному руководителю.
            </p>
          </div>
          ...
          >
            ...
            <span>{showRecommendationTemplate ? 'Скрыть шаблон' : 'Открыть шаблон письма'}</span>
          </button>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h4 className="text-sm font-bold text-slate-900">
              Структура мотивационного эссе
            </h4>
            <p className="text-xs text-slate-500 leading-relaxed">
              Модульный план Personal Statement для зарубежных университетов и NU.
            </p>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h4 className="text-sm font-bold text-slate-900">
              Сводный календарь контрольных дат
            </h4>
            <p className="text-xs text-slate-500 leading-relaxed">
              График дедлайнов приемных кампаний с возможностью экспорта в календарь.
            </p>
          </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4 animate-fadeIn">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-900 uppercase tracking-wider">
              Шаблон обращения за академической рекомендацией:
            </span>
            <button
            ...
            >
              ...
              <span>{copiedTemplate ? 'Скопировано' : 'Копировать'}</span>
            </button>
          </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-slate-200">
        ...
        >
          ...
          <span>Назад к карте маршрута</span>
        </button>
        ...
        >
          <span>Завершить и обновить профиль</span>
        </button>
      </div>
