    ...
    content: (
      <div className="space-y-6 text-center max-w-2xl mx-auto py-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-700 text-xs font-bold font-mono">
          <span>Официальный кейс 02 • Код сабмита: LOCUSCASE2</span>
        </div>
        <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-tight">
          AdmitRoute <span className="text-indigo-600">AI</span>
        </h1>
        <p className="text-lg sm:text-xl text-slate-600 font-medium leading-relaxed">
          «Превращаем профиль, оценки и бюджет абитуриента в понятный маршрут: куда поступать, почему это подходит и что делать прямо сейчас».
        </p>
        <div className="pt-4 grid grid-cols-3 gap-3 text-xs">
          <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200 font-semibold text-slate-700">
            🎯 1 Полный путь от анкеты до плана
          </div>
          <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200 font-semibold text-slate-700">
            💎 Сильный UX/UI и дизайн-система
          </div>
          <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200 font-semibold text-slate-700">
            💰 Фокус на 100% гранты (РК и Мир)
          </div>
        </div>
      </div>
    )
    ...
    content: (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-4">
        <div className="p-5 bg-rose-50 rounded-2xl border border-rose-200 space-y-3">
          ...
          <h4 className="font-extrabold text-rose-950 text-sm">Информационный хаос</h4>
          <p className="text-xs text-rose-900 leading-relaxed">
            Требования, дедлайны и правила разбросаны по десяткам разрозненных сайтов. Школьник тратит недели на поиск, но не понимает, кому верить.
          </p>
        </div>
        ...
        <div className="p-5 bg-amber-50 rounded-2xl border border-amber-200 space-y-3">
          ...
          <h4 className="font-extrabold text-amber-950 text-sm">Слепые рекомендации</h4>
          <p className="text-xs text-amber-900 leading-relaxed">
            Существующие каталоги выдают безликие списки вузов без объяснения причин. Нет ответа на вопрос: «Почему этот вариант подходит именно мне с моим GPA и $0 бюджета?»
          </p>
        </div>
        ...
        <div className="p-5 bg-indigo-50 rounded-2xl border border-indigo-200 space-y-3">
          ...
          <h4 className="font-extrabold text-indigo-950 text-sm">Паралич действия</h4>
          <p className="text-xs text-indigo-900 leading-relaxed">
            Десятки предстоящих экзаменов и документов вызывают стресс и прокрастинацию. Абитуриент не знает, какое действие предпринять на текущей неделе.
          </p>
        </div>
      </div>
    )
      ...
      <div className="space-y-4 py-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
            ...
            <h4 className="font-bold text-sm text-slate-900">Интеллектуальная диагностика</h4>
            <p className="text-xs text-slate-600 leading-relaxed">
              Мгновенный расчет индекса готовности (Readiness Index), определение сильных сторон (Superpowers) и выявление критических узких мест (Bottlenecks).
            </p>
          </div>

          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
            <span className="text-xl">🎯</span>
            <h4 className="font-bold text-sm text-slate-900">Объяснимый подбор (Explainable AI)</h4>
            <p className="text-xs text-slate-600 leading-relaxed">
              Разбивка на эшелоны: Dream, Target и Safety. Человеческое обоснование каждого выбора с учетом точных баллов и финансовой стратегии.
            </p>
          </div>

          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
            <span className="text-xl">🗺️</span>
            <h4 className="font-bold text-sm text-slate-900">Динамический Roadmap</h4>
            <p className="text-xs text-slate-600 leading-relaxed">
              Хронологический таймлайн с фильтрами по экзаменам, документам, эссе и дедлайнам с сохранением прогресса в реальном времени.
            </p>
          </div>

          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
            <span className="text-xl">⚡</span>
            <h4 className="font-bold text-sm text-slate-900">Один четкий шаг прямо сейчас</h4>
            <p className="text-xs text-slate-600 leading-relaxed">
              Фокус недели: интерактивный чеклист, готовый шаблон письма учителю за рекомендацией и конструктор структуры эссе.
            </p>
          </div>
        </div>
      </div>
    ...
    content: (
      <div className="space-y-4 py-2">
        ...
        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-xs text-slate-600 space-y-1">
          <span className="font-bold text-slate-900 block">✨ UX/UI достижения:</span>
          <p>• Пользователь на каждом экране четко понимает текущее положение, предыдущие действия и следующий шаг.</p>
          <p>• Полная адаптивность под экраны мобильных устройств и планшетов.</p>
          <p>• Мгновенная реактивность: при изменении бюджета или баллов весь маршрут синхронно перестраивается.</p>
        </div>
      </div>
    )
  },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-2 text-xs">
        <div className="p-5 rounded-2xl bg-white border border-slate-200 space-y-3">
          <h4 className="font-extrabold text-slate-900 text-sm flex items-center gap-1.5">
            ...
            <span>Формула готовности (Readiness Index)</span>
          </h4>
          <p className="text-slate-600 leading-relaxed">
            Взвешенный многофакторный скоринг:
          </p>
          ...
          <p className="text-slate-500">
            Исключает завышенные ожидания и честно предупреждает о дефиците баллов до подачи документов.
          </p>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200 space-y-3">
          <h4 className="font-extrabold text-slate-900 text-sm flex items-center gap-1.5">
            ...
            <span>Персонализированные объяснения</span>
          </h4>
          <p className="text-slate-600 leading-relaxed">
            Для каждого рекомендованного университета динамически формируется блок «Почему подходит именно вам», сопоставляющий бюджет семьи ($0 / грант), результаты SAT/IELTS/ЕНТ и олимпиадные дипломы.
          </p>
          <div className="p-3 rounded-xl bg-emerald-50 text-emerald-950 border border-emerald-200 text-[11px]">
            «Подходит, так как ваш GPA 3.9 и IELTS 7.5 полностью закрывают академический порог, а бюджет $0 компенсируется 100% стипендией KISS / грантом МНВО РК».
          </div>
        </div>
      </div>
    )
      ...
      <div className="space-y-4 py-2 text-xs">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-1">
            ...
            <div className="text-slate-500 text-[11px]">Компонентная модель</div>
          </div>
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-1">
            <span className="font-mono font-black text-blue-700 text-base">TypeScript</span>
            <div className="text-slate-500 text-[11px]">100% строгая типизация</div>
          </div>
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-1">
            <span className="font-mono font-black text-cyan-700 text-base">Vite + Tailwind</span>
            <div className="text-slate-500 text-[11px]">Мгновенная скорость и UI</div>
          </div>
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-1">
            <span className="font-mono font-black text-emerald-700 text-base">Local State</span>
            <div className="text-slate-500 text-[11px]">Сохранение прогресса</div>
          </div>
        </div>

        <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
          <span className="font-bold text-slate-900 block">Верифицированная база данных приемных комиссий 2026/2027:</span>
          <p className="text-slate-600 leading-relaxed">
            Включает актуальные данные ведущих вузов РК (Nazarbayev University, AITU, KIMEP, SDU), Европы (Constructor/Jacobs, Bocconi, PoliTo, Stipendium Hungaricum), Азии (KAIST, HKUST) и США (Need-Blind Amherst, NYUAD).
          </p>
        </div>
      </div>
    )
    ...
    content: (
      <div className="space-y-4 py-2 text-xs">
        <div className="overflow-x-auto rounded-2xl border border-slate-200">
          <table className="w-full text-left">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="p-3 font-bold text-slate-600">Критерий</th>
                <th className="p-3 font-bold text-slate-400">Обычные каталоги вузов</th>
                <th className="p-3 font-bold text-slate-400">Обычный AI-чат (ChatGPT)</th>
                <th className="p-3 font-extrabold text-indigo-700 bg-indigo-50/50">AdmitRoute AI</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              <tr>
                <td className="p-3 font-semibold text-slate-800">Формат результата</td>
                <td className="p-3 text-slate-500">Простыня ссылок</td>
                <td className="p-3 text-slate-500">Длинная стена текста</td>
                <td className="p-3 font-bold text-indigo-700 bg-indigo-50/20">Интерактивный 7-шаговый маршрут</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-slate-800">Объяснение «Почему подходит»</td>
                <td className="p-3 text-slate-500">Отсутствует</td>
                <td className="p-3 text-slate-500">Часто абстрактное / вымышленное</td>
                <td className="p-3 font-bold text-emerald-700 bg-indigo-50/20">Точный расчет по баллам и грантам</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-slate-800">Действие на эту неделю</td>
                <td className="p-3 text-slate-500">Нет</td>
                <td className="p-3 text-slate-500">Общие советы</td>
                <td className="p-3 font-bold text-indigo-700 bg-indigo-50/20">Шаг #1 + чеклист + шаблоны писем</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <p className="text-slate-500 text-center italic">
          Потенциал B2B партнерств со школами (НИШ, БИЛ) и профориентационными центрами Центральной Азии.
        </p>
      </div>
    )
  },
      ...
      <div className="space-y-6 text-center max-w-xl mx-auto py-4">
        ...
        <div className="space-y-2">
          <h3 className="text-xl sm:text-2xl font-black text-slate-900">
            Кейс 02 полностью реализован!
          </h3>
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            Создан самостоятельный работающий веб-сервис с авторской дизайн-системой, полным 7-шаговым пользовательским сценарием, высокой реактивностью и готовыми инструментами для абитуриента.
          </p>
        </div>

        <div className="p-4 rounded-2xl bg-indigo-50 border border-indigo-100 text-xs font-semibold text-indigo-900 space-y-1">
          <div>Код участия кейса: <strong className="font-mono text-indigo-700">LOCUSCASE2</strong></div>
          <div>Платформа подачи: <strong className="font-mono text-indigo-700">aistartify.com</strong></div>
        </div>
      </div>
    )
  }
