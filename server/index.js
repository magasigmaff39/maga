// AdmitRoute AI backend — standalone Node server (development and non-Firebase hosting).
...
async function start() {
  ...
  app.listen(config.port, config.host, () => {
    console.log(`\nAdmitRoute AI backend → http://${config.host}:${config.port}`);
    console.log(`База: ${UNIVERSITY_COUNTS.total} университетов (KZ ${UNIVERSITY_COUNTS.kazakhstan}, USA/CA ${UNIVERSITY_COUNTS.usa_canada}, EU ${UNIVERSITY_COUNTS.europe}, Asia ${UNIVERSITY_COUNTS.asia}), ${OLYMPIAD_COUNTS.total} олимпиад и конкурсов`);
